// Save a custom request
// database-storage.ts
export async function createCustomRequest(images, comment, product_id) {
    const result = await db.query(`INSERT INTO bouquetbar.custom (images, comment, product_id) VALUES ($1, $2, $3) RETURNING *`, [images, comment, product_id]);
